package com.zhuanjingkj.zjcbe.db;
...
public class RedisConfig {
    ...
    @Bean
    @ConditionalOnBean(name = "defaultRedisTemplate")
    public RedisTemplate<String, Object> defaultRedisTemplate(
            LettuceConnectionFactory defaultLettuceConnectionFactory) {
        /*DefaultRedisConfig config = new RedisConfig.DefaultRedisConfig();
        RedisStandaloneConfiguration defaultRedisConfig = config.defaultRedisConfig();
        GenericObjectPoolConfig defaultPoolConfig = config.defaultPoolConfig();
        LettuceConnectionFactory defaultLettuceConnectionFactory = defaultLettuceConnectionFactory(
                defaultRedisConfig, defaultPoolConfig
        );*/
    ...
    public LettuceConnectionFactory localLettuceConnectionFactory(
            RedisStandaloneConfiguration localRedisConfig,
    ...
    public RedisTemplate<String, String> localRedisTemplate(
            LettuceConnectionFactory localLettuceConnectionFactory) {
